USCF_Ratings.py takes in a list of USCF (US Chess Federation) player IDs and prints the names of the players in the orders of most regular rating, most blitz rating, and most improvement in regular rating.
USCF_Ratings.ipynb gives an output based on a sample input.
